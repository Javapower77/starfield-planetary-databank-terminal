...
Function CheckCompletePlanetSurvey(planet planetToCheck, Bool bForceCompletion)
  Debug.Trace("::SQ_ParentScript::DEBUG::VERBOSE->IN:FUNCTION: CheckCompletePlanetSurvey(planet planetToCheck, Bool bForceCompletion)", 0)
  Guard planetSurveyLock ;*** WARNING: Experimental syntax, may be incorrect: Guard  ; #DEBUG_LINE_NO:730
    If planetToCheck.HasKeyword(LocTypeMajorOrbital) ; #DEBUG_LINE_NO:734
      ...
      If currentSurvey > lastSurveyReward ; #DEBUG_LINE_NO:742
        ...
        If currentRewardThreshold > lastSurveyReward ; #DEBUG_LINE_NO:761
          ...
          Debug.Trace("::SQ_ParentScript::DEBUG::VERBOSE->spaceshipreference playerShipRef: " + playerShipRef as String, 0)
          ...
          Else
            ...
            Debug.Trace("::SQ_ParentScript::DEBUG::VERBOSE->SQ_PlanetIsHabitableKeyword: " + SQ_PlanetIsHabitableKeyword as String, 0)
            Debug.Trace("::SQ_ParentScript::DEBUG::VERBOSE->SQ_PlanetIsHabitable.IsTrue(): " + SQ_PlanetIsHabitable.IsTrue(playerShipRef as ObjectReference, None) as String, 0)
            ...
            Debug.Trace("::SQ_ParentScript::DEBUG::VERBOSE->SQ_SurveySlateEvent: " + SQ_SurveySlateEvent as String, 0)
    ...
    EndIf
  EndGuard ;*** WARNING: Experimental syntax, may be incorrect: EndGuard 
  Debug.Trace("::SQ_ParentScript::DEBUG::VERBOSE->OUT:FUNCTION: CheckCompletePlanetSurvey(planet planetToCheck, Bool bForceCompletion)", 0)
EndFunction
...
Float Function GetPlanetAbundanceValue(planet planetToCheck)
    Debug.Trace("::SQ_ParentScript::DEBUG::VERBOSE->IN:FUNCTION: GetPlanetAbundanceValue(planet planetToCheck)", 0)
    
    Debug.Trace("::SQ_ParentScript::DEBUG::VERBOSE->Getting Flora Abundance ...", 0)
  
    Keyword[] matchingKeywords = planetToCheck.GetKeywordTypeList(KeywordType_PlanetFloraAbundance) ; #DEBUG_LINE_NO:987
    Debug.Trace("::SQ_ParentScript::DEBUG::VERBOSE->matchingKeywords: " + matchingKeywords as String, 0)
    Debug.Trace("::SQ_ParentScript::DEBUG::VERBOSE->matchingKeywords.Length: " + matchingKeywords.Length as String, 0)
    ...
    While I < matchingKeywords.Length ; #DEBUG_LINE_NO:990
      ...
      Debug.Trace("::SQ_ParentScript::DEBUG::VERBOSE->Keyword planetKeyword: " + planetKeyword as String, 0)
      Int planetTraitIndex = PlanetAbundanceKeywords.findstruct("planetKeyword", planetKeyword, 0) ; #DEBUG_LINE_NO:993
      Debug.Trace("::SQ_ParentScript::DEBUG::VERBOSE->Int planetTraitIndex: " + planetTraitIndex as String, 0)
      If planetTraitIndex > -1 ; #DEBUG_LINE_NO:994
        ...
        Debug.Trace("::SQ_ParentScript::DEBUG::VERBOSE->PlanetAbundanceKeywords[planetTraitIndex]: " + PlanetAbundanceKeywords[planetTraitIndex] as String, 0)
        Debug.Trace("::SQ_ParentScript::DEBUG::VERBOSE->theData.surveyDifficulty: " + theData.surveyDifficulty as String, 0)
        totalSurveyValue += theData.surveyDifficulty ; #DEBUG_LINE_NO:996
      EndIf
      I += 1 ; #DEBUG_LINE_NO:999
    EndWhile
    Debug.Trace("::SQ_ParentScript::DEBUG::VERBOSE->End getting Flora Abundance ...", 0)
  
    Debug.Trace("::SQ_ParentScript::DEBUG::VERBOSE->Getting Fauna Abundance ...", 0)
    ...
    Debug.Trace("::SQ_ParentScript::DEBUG::VERBOSE->End getting Flora Abundance ...", 0)
    Debug.Trace("::SQ_ParentScript::DEBUG::VERBOSE->OUT:FUNCTION: GetPlanetAbundanceValue(planet planetToCheck)", 0)
EndFunction
